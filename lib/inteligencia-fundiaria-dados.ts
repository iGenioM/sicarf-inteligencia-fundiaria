...
export const DADOS_PA: DadosDemonstracao = {
  ...
  municipiosSelect: ["Macapá", "Santana", "Laranjal do Jari", "Oiapoque"],
  glebasPorTipoGleba: {
    municipal: [
      "Gleba Manguari",
      "Gleba Rio Fresco",
  ...
  campanhaConcluidaTitulo:
    "Campanha Norte do Amapá — Oiapoque / Calçoene (REURB)",
  ...
  acompLinhasFinalizados: [
    { rotulo: "Mazagão", valores: ["128", "4.920", "REURB"] },
    { rotulo: "Oiapoque", valores: ["96", "3.410", "Quilombola"] },
  ],
  acompColunasReurb: [
    "Núcleo / gleba",
    "Tipo",
  ...
  historicoCampanha: [
    { quando: "15/04 09:47", texto: "Gargalo registrado: Macapá — 3ª etapa (CRF)" },
    { quando: "14/04 16:12", texto: "Redistribuição: +2 técnicos em Santana" },
    { quando: "13/04 11:05", texto: "Parecer favorável — lote CCGEO 12" },
  ],
  outrasCampanhas: [
    {
...
export const DADOS_MA: DadosDemonstracao = {
  ...
  municipiosSelect: ["Macapá", "Santana", "Mazagão", "Oiapoque"],
  glebasPorTipoGleba: {
  ...
  acompLinhasRural: [
    {
      rotulo: "Macapá — fluxo principal",
      valores: [78, 71, 66, 59, 52, 49, 45, 41, 36, 31, 27, 23, 19, 16],
      destaqueIdx: 2,
    },
    {
      rotulo: "Santana — 2ª etapa",
      valores: [64, 58, 54, 48, 43, 39, 35, 32, 28, 24, 21, 18, 15, 12],
    },
    {
      rotulo: "Mazagão — análise",
      valores: [52, 47, 43, 38, 34, 30, 27, 24, 20, 17, 14, 12, 10, 8],
    },
  ],
  acompColunasFinalizados: [
    "Município",
  ...
  acompLinhasFinalizados: [
    { rotulo: "Oiapoque", valores: ["112", "4.200"] },
    { rotulo: "Laranjal do Jari", valores: ["88", "3.050"] },
  ],
  acompColunasReurb: [
    "Núcleo / gleba",
    "Tipo",
  ...
  gargalosSetor: [
    ...
    { setor: "CCGEO", pct: 67 },
    { setor: "CRF", pct: 81 },
    { setor: "Jurídico", pct: 64 },
    { setor: "DIROT", pct: 59 },
    { setor: "DIPRE", pct: 73 },
    { setor: "Governo", pct: 52 },
  ],
  historicoCampanha: [
    { quando: "15/04 09:12", texto: "Gargalo registrado: Macapá — 3ª etapa (CRF)" },
    { quando: "14/04 15:40", texto: "Redistribuição: +2 técnicos em Santana" },
    { quando: "13/04 10:22", texto: "Parecer favorável — lote CCGEO 09" },
  ],
  outrasCampanhas: [
    {
      titulo: "Campanha Sul do Amapá",
