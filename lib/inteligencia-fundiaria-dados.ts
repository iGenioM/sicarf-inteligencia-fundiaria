...
const MUNICIPIOS_MA_POR_MESORREGIAO: Record<string, string[]> = {
  "Centro Maranhense": [
    "Arame",
    "Bacabal",
    "Barra do Corda",
...
export const DADOS_PA: DadosDemonstracao = {
  ...
  equipesOperacionais: [
    { id: "eq-norte", nome: "Equipe Norte", processosPorDia: 14.1 },
    { id: "eq-sul", nome: "Equipe Sul", processosPorDia: 14.8 },
    { id: "eq-leste", nome: "Equipe Leste", processosPorDia: 15.4 },
    { id: "eq-oeste", nome: "Equipe Oeste", processosPorDia: 16.2 },
    { id: "eq-centro", nome: "Equipe Centro", processosPorDia: 16.7 },
    { id: "eq-movel", nome: "Equipe Móvel", processosPorDia: 15.9 },
  ],
...
export const DADOS_MA: DadosDemonstracao = {
  ...
  municipiosPorRegiao: MUNICIPIOS_MA_POR_MESORREGIAO,
  glebasPorTipoGleba: {
  ...
  equipesOperacionais: [
    { id: "ma-eq-1", nome: "Equipe Imperatriz", processosPorDia: 14.3 },
    { id: "ma-eq-2", nome: "Equipe Baixada", processosPorDia: 15.1 },
    { id: "ma-eq-3", nome: "Equipe Oeste", processosPorDia: 16.4 },
    { id: "ma-eq-4", nome: "Equipe Móvel", processosPorDia: 15.7 },
    { id: "ma-eq-5", nome: "Equipe Leste", processosPorDia: 16.9 },
    { id: "ma-eq-6", nome: "Equipe Centro", processosPorDia: 14.6 },
  ],
